...
\end{description}
\includegraphics[scale=0.27]{ls-la}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Keep track of open files for each process
		\item Every entry points to system-wide open-file table entry
	\end{itemize}
	\item System-wide open-file table
	\begin{itemize}
		\item Keep track of all open files in system 
