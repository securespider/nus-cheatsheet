...
\end{itemize}
\includegraphics[scale=0.33]{os-interaction}
\begin{description}
...
\end{itemize}
\includegraphics[scale=0.3]{monolithic-os}
...
\begin{itemize}
	\item Handle signal via default or user supplied handlers
	\item Can only call async safe functions (signal/wait cannot be called in POSIX)
