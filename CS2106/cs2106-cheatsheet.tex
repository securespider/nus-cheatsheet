...
\begin{itemize}
	...
	\begin{description}
		\item[Memory resident]{Pages in phy memory}
	...
	\begin{itemize}
		\item CPU can only access mem resident pages
...
\begin{itemize}
	...
	\item Every proc needs a page table
...
\begin{itemize}
	...
	\item Page directory keep track of smaller page tables
\end{itemize}
\textbf{Problems}
\begin{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item Second-Change Page Replacement
	\begin{itemize}
...
\end{description}
\includegraphics[scale=0.23]{ls-la}
